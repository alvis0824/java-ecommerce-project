        ...
        while(true){
            ...
            switch (menuSelection){
                case 0:   // list categories
                    for (Category each : StaticConstants.CATEGORY_LIST) {
                        System.out.println("Category Code: " + each.generateCategoryCode() + " Category name:" + each.getName());
                    }
                    break;
                ...
                case 4:
                    ...
                    System.out.println("Type 2 for Gif Card Balance:" + giftCardBalance.getBalance());

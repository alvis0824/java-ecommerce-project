...
import discount.AmountBaseDiscount;
...
public class DataGenerator {
    ...
    public static void createBalance(){
        ...
        Balance giftCardBalance = new CustomerBalance(StaticConstants.CUSTOMER_LIST.get(1).getId(), 500.00);
    ...
    public static void createDiscount(){
        Discount amountBasedDiscount = new AmountBaseDiscount(UUID.randomUUID(), "Buy 250 Free 50", 250.00, 50.00);
